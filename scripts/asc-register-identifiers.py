#!/usr/bin/env python3
"""Register Caffeine bundle IDs and enable their required capabilities."""
...
IDENTIFIERS = {
    "com.jackwallner.caffeine": ("Caffeine", {"HEALTHKIT", "APP_GROUPS", "IN_APP_PURCHASE"}),
    "com.jackwallner.caffeine.widget": ("Caffeine Widget", {"APP_GROUPS"}),
    "com.jackwallner.caffeine.watch": ("Caffeine Watch", {"HEALTHKIT", "APP_GROUPS"}),
    "com.jackwallner.caffeine.watch.widget": ("Caffeine Watch Widget", {"APP_GROUPS"}),
}
